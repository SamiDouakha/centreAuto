...
public class FacturationService implements IFacturationService{
    ...
    @Override
    public Particulie addParticulie(Particulie particulie) {
        return dao.addParticulie(particulie);
    }

    @Override
    public Particulie consulterParticulie(Long id) {
        return dao.consulterParticulie(id);
    }

    @Override
    public Long updateParticulie(Particulie p) {
    ...
    public List<Professionnel> consulterProfessionnelBySiret(String siret) {
        return dao.consulterProfessionnelBySiret(siret);
    }
