...
public class FormulaireProfessionnel extends Formulaire{
    protected ChampSiret champSiret;
    ...
    public FormulaireProfessionnel(String siret,String nomSociete,String lieuSociete,String villeSociete,String codePostalSociete) 
    {
            champSiret = new ChampSiret(siret);
    ...
    public String getSiret() {
        return champSiret.getValue();
    }
    
    public void setSiret(String siret) {
        this.champSiret.setValue(siret);
    }
    ...
    public String  hydrate()
    {
        ...
        {    
            this.professionnel.setSiret(this.getSiret().toUpperCase(Locale.FRANCE));
